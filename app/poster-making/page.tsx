...
import { ShieldCheck, Palette, Award, CheckCircle2, ArrowRight, ArrowLeft } from "lucide-react";

export const metadata = {
  title: "Poster Making Competition — VAJRA",
  description: "Express social vision through visual art. Poster making competition organized by SWB & NSS Unit, CMRCET.",
};

export default function PosterMakingPage() {
  const event = eventsMap["poster-making"];
  ...
  return (
    <div className="relative min-h-screen bg-navy-950">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 py-16 space-y-20">
        ...
        {event.themes && (
          <section>
            <SectionDivider title="Themes & Prompts" />
            <div className="text-center mb-10">
              <h2 className="font-serif text-3xl font-bold text-white mb-2">Artistic Themes</h2>
              <p className="text-slate-400 text-sm">Posters should visually interpret one of the following themes:</p>
            </div>
                  ...
                  <div className="glass-card p-6 rounded-2xl border border-gold-500/20 hover:border-gold-500/40 transition-colors flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-400 leading-relaxed">
                        Original creative interpretation focusing on clarity of message and visual impact.
                      </p>
                    </div>
                  </div>
                </ScrollReveal>
        ...
        <section>
          ...
          <div className="text-center mb-10">
            <h2 className="font-serif text-3xl font-bold text-white mb-2">Competition Guidelines</h2>
            <p className="text-slate-400 text-sm">Adhere strictly to these rules during the event:</p>
          </div>
        ...
        {event.judgingCriteria && (
          <section>
            <SectionDivider title="Evaluation" />
            <div className="text-center mb-10">
              <h2 className="font-serif text-3xl font-bold text-white mb-2">Judging Criteria</h2>
              <p className="text-slate-400 text-sm">Entries will be evaluated by an esteemed panel based on:</p>
            </div>
        ...
        <section className="glass-card p-10 rounded-3xl border border-gold-500/40 text-center relative overflow-hidden shadow-[0_0_40px_rgba(212,175,55,0.15)]">
          ...
          <div className="relative z-10">
            <h2 className="font-serif text-3xl sm:text-4xl font-bold text-white mb-3">Ready to Showcase Your Vision?</h2>
            <p className="text-slate-300 text-base max-w-xl mx-auto mb-8">
              Register now for Poster Making at VAJRA. Spots are limited!
            </p>
